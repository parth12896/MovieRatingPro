...
var contextPath='<%=request.getContextPath()%>';
 ...
 <script src="<%=request.getContextPath()%>/customjs/savemovie.js"></script>
</head>
<body>
  ...
  <div class="col-xs-12">
    <div ng-app="app" ng-controller="addMovieController">
        ...
        <div class="col-xs-12">
        	...
        	<div class="form-group">
   			 <div class="col-sm-offset-6 col-sm-6">
      				<button type="submit" ng-disabled="showInfoMessage" class="btn btn-primary" ng-click="performMovie()">Add Movie Name</button>
    		</div>
  			</div>
        	</div>
