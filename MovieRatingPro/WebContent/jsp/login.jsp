...
<%@page
	import="com.model.AJAXResponseLogin,java.util.List,com.model.ErrorMessagesObj"%>
...
<body>
	<%
	AJAXResponseLogin ajax = (AJAXResponseLogin) request.getAttribute(ReviewConstantsIF.Keys.OBJ);
	...
	<div class="module form-module">
		...
		<div class="form">
			...
			<form action="<%=request.getContextPath()%>/review/login.do"
				method="post">
