...
<head>
	...
	var register_end_point='<%=ReviewConstantsIF.EndPoints.REGISTER_ENDPOINT%>';
	var app_name_registered='<%=ReviewConstantsIF.Keys.APP_NAME%>';
	</script>

	   <script src="<%=request.getContextPath()%>/customjs/registerApp.js"></script>
